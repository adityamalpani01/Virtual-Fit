...
def predict():
    ...
    # |||||||||||||||||||||||||||||||SHIRT||||||||||||||||||||||||||||||||||||||||
            ...
            break
        cv2.putText(img, "Shirt Width: {}".format(shirtWidth), (50, 50),
                    cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 255), 2, cv2.LINE_4)
        cv2.putText(img, "Shirt Height: {}".format(shirtHeight), (50, 80),
                    cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 255), 2, cv2.LINE_4)
        cv2.putText(img, "Pant Width: {}".format(pantWidth, pantHeight),
                    (50, 110), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 255), 2, cv2.LINE_4)
        cv2.putText(img, "Pant Height: {}".format(pantHeight), (50, 140),
                    cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 255), 2, cv2.LINE_4)
